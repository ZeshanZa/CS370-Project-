...
function Page() {
    ...
    useEffect(() => {
        fetch('https://ecsconnectbackend.com:8000/masterskills/')
    ...
    useEffect(() => {
        const fetchUserSkills = async () => {
            try {
                ...
                const response = await axios.get(`https://ecsconnectbackend.com:8000/skills/${profile.user_id}/get-complete-skills/`);
    ...
    const updateSkillsOnServer = async (category, newSkills, type) => {
        const url = `https://ecsconnectbackend.com:8000/skills/${profile.user_id}/${type}/${category}/update-skills/`;
        try {
