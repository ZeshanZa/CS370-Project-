...
const AuthForm = () => {
  ...
  return (
    <>
      <div className='flex justify-center flex-col items-center w-screen h-[100dvh] min-[750px]:hidden'> {/*This is for phone*/}
    ...
    {/* <div className='w-full h-full items-center flex justify-center'>
      ...
      <div className='flex justify-center flex-row items-center w-screen h-[100dvh] max-[750px]:hidden'> {/*This is for laptop*/}
        {/* Text and TypeAnimation components are correctly implemented here */}
        <text className='absolute top-5 left-5 text-3xl'> <span className='text-blue-600'>Emory</span> <span className='text-blue-400'>Connect</span> </text>
