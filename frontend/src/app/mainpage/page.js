          ...
          <div className="p-2 h-[100dvh]">
            <div className="w-full h-full rounded-lg px-4 flex flex-col">
              ...
              <div className="flex flex-grow items-center justify-center">
                <button className="bg-gray-300 py-1 w-full rounded-md text-slate-700 hover:bg-gray-500 hover:text-slate-200">
                  {" "}
                  Sign Out{" "}
                </button>
              </div>
          ...
          <div className="w-full flex-wrap flex justify-center">
            <div className="w-full h-full">
              <div className="w-full p-2">
                ...
                <div>
                  {projects.length === 0 && showAddProjectForm !== true && (
                ...
                <div>
                  ...
                  <button
                    className="underline"
                    hidden={itemsToShow >= projects.length}
                    onClick={() => {
