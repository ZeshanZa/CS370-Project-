...
function ProjectsPage() {
    ...
    const handleAddProjectSubmit = async (e) => {
        ...
        try {
            await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/projects/create/`, projectData, { //I decided to remove local variable since some of yall are havin issues so just put URL instead 
                headers: {
                    'Authorization': `Token ${token}`,
    ...
    const handleEditSubmit = async (e) => {
        ...
        const token = localStorage.getItem('access_token');
        try {
            await axios.put(`${process.env.NEXT_PUBLIC_API_URL}/projects/${editingProjectId}/`, {
                title: editTitle,
                        ...
                        <div className='w-full h-full'>
                            ...
                            <div className='w-full p-2'>
                                ...
                                <div>
                                    ...
                                    <button className='underline' hidden={itemsToShow >= projects.length || projects.length <= 2} onClick={() => {
